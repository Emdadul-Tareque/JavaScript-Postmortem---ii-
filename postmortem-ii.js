...
localStorage.getItem('def')

localStorage.setItem('def', 245)

// if existing value wants to set 

localStorage.getItem()
const nextIDJSON = localStorage.getItem(" ")

const nextId = JSON.parse(nextIDJSON)

nextId.user = "Hero "

const nextIdStringify = JSON.stringify(nextId);

localStorage.setItem("", nextIdStringify )
